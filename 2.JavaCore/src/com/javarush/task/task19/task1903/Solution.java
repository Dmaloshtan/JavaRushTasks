...
public class Solution {
    ...
    public static String getPhoneNumber(int code, int data) {
        String formatNumber = String.valueOf(data);
        return "+" + code + "(0" + formatNumber.substring(0,2)
                + ")" + formatNumber.substring(2,5) + "-" + formatNumber.substring(5,7)
                + "-" + formatNumber.substring(7,9);
    }
    ...
    public static void main(String[] args) {
        System.out.println(getPhoneNumber(38, 501234567));
    }
